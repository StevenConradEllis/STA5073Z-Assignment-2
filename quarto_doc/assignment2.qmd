...
```{r fig-R, echo=FALSE, eval=TRUE,warning=FALSE,fig.align='center',message=FALSE,fig.cap="Evolution of emotions expressed over time from 1994-2023 by all presidents"}
