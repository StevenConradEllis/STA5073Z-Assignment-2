...
# common_words_Mandela <- sona_sentiment %>% 
#   filter(pres == 'Mandela') %>%
#   unnest_tokens(word, speech, token = 'regex', pattern = unnest_reg) %>%
#   filter(str_detect(word, '[a-z]')) %>% 
#   filter(!word %in% stop_words$word) %>%
...
# 
# common_words_deKlerk <- sona_sentiment %>% 
#   filter(pres == 'deKlerk') %>%
#   unnest_tokens(word, speech, token = 'regex', pattern = unnest_reg) %>%
#   filter(str_detect(word, '[a-z]')) %>% 
#   filter(!word %in% stop_words$word) %>%
...
# 
# common_words_Mbeki <- sona_sentiment %>% 
#   filter(pres == 'Mbeki') %>%
#   unnest_tokens(word, speech, token = 'regex', pattern = unnest_reg) %>%
#   filter(str_detect(word, '[a-z]')) %>% 
#   filter(!word %in% stop_words$word) %>%
...
# 
# 
# common_words_Zuma <- sona_sentiment %>% 
#   filter(pres == 'Zuma') %>%
#   unnest_tokens(word, speech, token = 'regex', pattern = unnest_reg) %>%
#   filter(str_detect(word, '[a-z]')) %>% 
#   filter(!word %in% stop_words$word) %>%
...
# 
# 
# common_words_Motlanthe <- sona_sentiment %>% 
...
# 
# 
# common_words_Ramaphosa<- sona_sentiment %>% 
...
overall_common_positive_words <- sona_sentiment %>% 
...
overall_common_negative_words <- sona_sentiment %>% 
  unnest_tokens(word, speech, token = 'words') %>%
  filter(str_detect(word, '[a-z]')) %>% 
  filter(!word %in% stop_words$word) %>%
  filter(!grepl(common_sona_reg, word)) %>%
...
common_positive_words_Mandela <- sona_sentiment %>% 
  filter(pres == 'Mandela') %>%
  unnest_tokens(word, speech, token = 'words') %>%
  filter(str_detect(word, '[a-z]')) %>% 
  filter(!word %in% stop_words$word) %>%
...
common_positive_words_deKlerk <- sona_sentiment %>% 
  filter(pres == 'deKlerk') %>%
  unnest_tokens(word, speech, token = 'words') %>%
  filter(str_detect(word, '[a-z]')) %>% 
  filter(!word %in% stop_words$word) %>%
...
common_positive_words_Mbeki <- sona_sentiment %>% 
  filter(pres == 'Mbeki') %>%
  unnest_tokens(word, speech, token = 'words') %>%
  filter(str_detect(word, '[a-z]')) %>% 
  filter(!word %in% stop_words$word) %>%
...
common_positive_words_Zuma <- sona_sentiment %>% 
  filter(pres == 'Zuma') %>%
  unnest_tokens(word, speech, token = 'words') %>%
  filter(str_detect(word, '[a-z]')) %>% 
  filter(!word %in% stop_words$word) %>%
...
common_positive_words_Motlanthe <- sona_sentiment %>% 
  filter(pres == 'Motlanthe') %>%
  unnest_tokens(word, speech, token = 'words') %>%
  filter(str_detect(word, '[a-z]')) %>% 
  filter(!word %in% stop_words$word) %>%
...
common_positive_words_Ramaphosa <- sona_sentiment %>% 
  filter(pres == 'Ramaphosa') %>%
  unnest_tokens(word, speech, token = 'words') %>%
  filter(str_detect(word, '[a-z]')) %>% 
  filter(!word %in% stop_words$word) %>%
...
common_negative_words_Mandela <- sona_sentiment %>% 
  filter(pres == 'Mandela') %>%
  unnest_tokens(word, speech, token = 'words') %>%
  filter(str_detect(word, '[a-z]')) %>% 
  filter(!word %in% stop_words$word) %>%
...
common_negative_words_deKlerk <- sona_sentiment %>% 
  filter(pres == 'deKlerk') %>%
  unnest_tokens(word, speech, token = 'words') %>%
  filter(str_detect(word, '[a-z]')) %>% 
  filter(!word %in% stop_words$word) %>%
...
common_negative_words_Mbeki <- sona_sentiment %>% 
  filter(pres == 'Mbeki') %>%
  unnest_tokens(word, speech, token = 'words') %>%
  filter(str_detect(word, '[a-z]')) %>% 
  filter(!word %in% stop_words$word) %>%
...
common_negative_words_Zuma <- sona_sentiment %>% 
  filter(pres == 'Zuma') %>%
  unnest_tokens(word, speech, token = 'words') %>%
  filter(str_detect(word, '[a-z]')) %>% 
  filter(!word %in% stop_words$word) %>%
...
common_negative_words_Motlanthe <- sona_sentiment %>% 
  filter(pres == 'Motlanthe') %>%
  unnest_tokens(word, speech, token = 'words') %>%
  filter(str_detect(word, '[a-z]')) %>% 
  filter(!word %in% stop_words$word) %>%
...
common_negative_words_Ramaphosa <- sona_sentiment %>% 
  filter(pres == 'Ramaphosa') %>%
  unnest_tokens(word, speech, token = 'words') %>%
  filter(str_detect(word, '[a-z]')) %>% 
  filter(!word %in% stop_words$word) %>%
...
overall_word_bing_sentiment_change_over_time <- sona_sentiment %>% 
...
overall_pos_neg_fluctuation <- sona_sentiment %>% 
  filter(!pres %in% c('deKlerk', 'Motlanthe')) %>% # excluding 1 time president
  unnest_tokens(word, speech, token = 'words') %>%
  filter(str_detect(word, '[a-z]')) %>% 
  filter(!word %in% stop_words$word) %>%
